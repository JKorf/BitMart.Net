...
* Version 3.9.0 - 24 Mar 2026
    ...
    * Notes for updating:
        * Update ApiCredentials to BitMartCredentials for authentication, i.e. `ApiCredentials = new ApiCredentials(..)` => `ApiCredentials = new BitMartCredentials(..)`
...
* Version 3.4.0 - 06 Feb 2026
    ...
    * Added BitMartUserSpotDataTracker and BitMartUserFuturesDataTracker
    ...
    * Fixed typo in DepositWithdrawalStatus enum
...
* Version 3.3.0 - 22 Jan 2026
    ...
    * Added Metadata to BitMartExchange
    * Fixed missing LimitMaker value in Shared REST SpotSupportedOrderTypes
...
* Version 3.2.0 - 13 Jan 2026
    ...
    * Added PlannedDelistTime property to restClient.SpotApi.ExchangeData.GetSymbolsAsync response model
...
* Version 3.0.0 - 16 Dec 2025
    ...
    * Added orderId and clientOrderId parameters to restClient.UsdFuturesApi.Trading.GetUserTrades endpoint
    * Updated Shared API's subscription update types from ExchangeEvent to DataEvent
    * Fixed Futures websocket query response error check
