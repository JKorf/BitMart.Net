    ...
    public class RestRequestTests
    {
        ...
        public async Task ValidateSpotAccountDataCalls()
        {
            var client = new BitMartRestClient(opts =>
            {
                ...
                opts.ApiCredentials = new BitMartCredentials("123", "456", "XXX");
            });
        ...
        public async Task ValidateUsdFuturesTradingCalls()
        {
            ...
            await tester.ValidateAsync(client => client.UsdFuturesApi.Trading.EditOrderAsync("123", 123), "EditOrder", nestedJsonProperty: "data");
