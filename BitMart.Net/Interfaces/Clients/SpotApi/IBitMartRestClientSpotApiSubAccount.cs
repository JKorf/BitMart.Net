...
namespace BitMart.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IBitMartRestClientSpotApiSubAccount
    {
        ...
        Task<HttpResult> TransferSubToMainForMainAsync(string clientOrderId, string asset, decimal quantity, string subAccount, CancellationToken ct = default);
        ...
        /// <param name="quantity">Quantity to transfer</param>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult> TransferSubToMainForSubAsync(string clientOrderId, string asset, decimal quantity, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult> TransferMainToSubAccountAsync(string clientOrderId, string asset, decimal quantity, string subAccount, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult> TransferSubAccountToSubAccountAsync(string clientOrderId, decimal quantity, string asset, string fromAccount, string toAccount, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<SubAccountTransferHistory>> GetSubAccountTransferHistoryForMainAsync(int limit, string? account = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<SubAccountTransferHistory>> GetSubAccountTransferHistoryAsync(int limit, CancellationToken ct = default);
        ...
        /// </summary>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<BitMartSubAccount[]>> GetSubAccountListAsync(CancellationToken ct = default);
