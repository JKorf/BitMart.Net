...
namespace BitMart.Net.Interfaces.Clients
{
    ...
    public interface IBitMartUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, BitMartEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBitMartRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, BitMartEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBitMartSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, BitMartEnvironment? environment = null);
    }
}